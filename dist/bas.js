...
THREE.BAS.ShaderChunk["ease_back_in"] = "float ease(float t, float b, float c, float d) {\n  float s = 1.70158;\n  return c*(t/=d)*t*((s+1.0)*t - s) + b;\n}\n\nfloat ease(float t, float b, float c, float d, float s) {\n  return c*(t/=d)*t*((s+1.0)*t - s) + b;\n}\n";

THREE.BAS.ShaderChunk["ease_back_in_out"] = "float ease(float t, float b, float c, float d) {\n  float s = 1.70158;\n  if ((t/=d/2.0) < 1.0) return c/2.0*(t*t*(((s*=(1.525))+1.0)*t - s)) + b;\n  return c/2.0*((t-=2.0)*t*(((s*=(1.525))+1.0)*t + s) + 2.0) + b;\n}\n\nfloat ease(float t, float b, float c, float d, float s) {\n  if ((t/=d/2.0) < 1.0) return c/2.0*(t*t*(((s*=(1.525))+1.0)*t - s)) + b;\n  return c/2.0*((t-=2.0)*t*(((s*=(1.525))+1.0)*t + s) + 2.0) + b;\n}\n";

THREE.BAS.ShaderChunk["ease_back_out"] = "float ease(float t, float b, float c, float d) {\n  float s = 1.70158;\n  return c*((t=t/d-1.0)*t*((s+1.0)*t + s) + 1.0) + b;\n}\n\nfloat ease(float t, float b, float c, float d, float s) {\n  return c*((t=t/d-1.0)*t*((s+1.0)*t + s) + 1.0) + b;\n}\n";

THREE.BAS.ShaderChunk["ease_cubic_in"] = "float ease(float t, float b, float c, float d) {\n  return c*(t/=d)*t*t + b;\n}\n";

THREE.BAS.ShaderChunk["ease_cubic_in_out"] = "float ease(float t, float b, float c, float d) {\n  if ((t/=d/2.0) < 1.0) return c/2.0*t*t*t + b;\n  return c/2.0*((t-=2.0)*t*t + 2.0) + b;\n}\n";

THREE.BAS.ShaderChunk["ease_cubic_out"] = "float ease(float t, float b, float c, float d) {\n  return c*((t=t/d - 1.0)*t*t + 1.0) + b;\n}\n";

THREE.BAS.ShaderChunk["ease_quad_in"] = "float ease(float t, float b, float c, float d) {\n  return c*(t/=d)*t + b;\n}\n";

THREE.BAS.ShaderChunk["ease_quad_in_out"] = "float ease(float t, float b, float c, float d) {\n  if ((t/=d/2.0) < 1.0) return c/2.0*t*t + b;\n  return -c/2.0 * ((--t)*(t-2.0) - 1.0) + b;\n}\n";

THREE.BAS.ShaderChunk["ease_quad_out"] = "float ease(float t, float b, float c, float d) {\n  return -c *(t/=d)*(t-2.0) + b;\n}\n";
...
THREE.BAS.ShaderChunk["ease_quint_in"] = "float ease(float t, float b, float c, float d) {\n    return c*(t/=d)*t*t*t*t + b;\n}\n";
